...
// Asegúrate de instalar e importar la fuente si usas Fontsource
...
// --- Paleta Base ---
// Añadimos contrastText para indicar qué color de texto va bien sobre el color principal
// const primaryColor = '#673ab7'; // Morado base
// const secondaryColor = '#ffc107'; // Amarillo base

// Paleta de colores
// Professional portfolio color palette
const backgroundDark = '#1E2A38'; // Soft navy dark background
const backgroundLight = '#F5F7FA'; // Light gray-white background
const primaryColor = '#2D5F8B';    // Professional blue
const secondaryColor = '#607B8B';  // Slate gray
const thirdColor = '#A67F5D';      // Warm accent (muted gold)
...
const sharedThemeOptions: ThemeOptions = {
  ...
  typography: {
    fontFamily: '"Playfair Display", "Montserrat Alternates", "Helvetica", "Arial", sans-serif',
